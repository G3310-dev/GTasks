...
class TeacherTasks extends StatelessWidget {
  ...
  TeacherTasks(this.col);
  @override
  Widget build(BuildContext context) {
    final CollectionReference collectionReference = FirebaseFirestore.instance.collection('tasks_$col');
    return Scaffold(
      floatingActionButton: FloatingActionButton(
          ...
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => Add(col)),
            );
          }
      ),
      appBar: AppBar(
